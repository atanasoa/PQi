...
public abstract class QueryAbstractSocketPort extends SocketComponent implements QuerySocketPort{

  protected Query  _destination;
  
  public QueryAbstractSocketPort() throws de.tum.ascodt.utils.exceptions.ASCoDTException {
    _destination = null;
  }
  
  public QueryAbstractSocketPort(String host,int port) throws de.tum.ascodt.utils.exceptions.ASCoDTException {
    super(host,port);
    _destination = null;
  }
