...
public class QuerySocketDispatcher extends  SocketComponent {
  private long _ref;
  protected java.util.HashSet<Query>  _destinations;
  
  public QuerySocketDispatcher() throws de.tum.ascodt.utils.exceptions.ASCoDTException{
    _destinations = new java.util.HashSet<Query>();
