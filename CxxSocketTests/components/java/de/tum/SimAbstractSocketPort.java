...
public abstract class SimAbstractSocketPort extends SocketComponent implements SimSocketPort{

  protected Sim  _destination;
  
  public SimAbstractSocketPort() throws de.tum.ascodt.utils.exceptions.ASCoDTException {
    _destination = null;
  }
  
  public SimAbstractSocketPort(String host,int port) throws de.tum.ascodt.utils.exceptions.ASCoDTException {
    super(host,port);
    _destination = null;
  }
